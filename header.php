...
<header style="z-index:10;">
    <nav>
        ...
        <ul>
            <li><a href="index"><img src="images/logo.png">Collective Shop Sphere</a></li>
            <li class="hideOnMobile"><a href="index">Home</a></li>
            <li class="hideOnMobile"><a href="about">About</a></li>
            <li class="hideOnMobile"><a href="shop">Shop</a></li>
            <li class="hideOnMobile"><a href="help">Help</a></li>
            <?php if(isset($_SESSION['username'])): ?>
                <li class="hideOnMobile"><a href="dashboard">Dashboard</a></li>
                <li class="hideOnMobile"><a href="#">Hello, <?php echo htmlspecialchars($_SESSION['username']); ?></a></li>
            <?php else: ?>
